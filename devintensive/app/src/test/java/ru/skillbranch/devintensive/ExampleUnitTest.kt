...
import ru.skillbranch.devintensive.model.BaseMessage
import ru.skillbranch.devintensive.model.Chat
...
class ExampleUnitTest {
    ...
    fun test_abstract_factory() {
        ...
        assertEquals("id:0 Евгений отправил сообщение \"any text message\" только что", textMessage.formatMessage())
        assertEquals("id:1 Евгений получил изображение \"https://anyurl.com\" 2 часа назад", imageMessage.formatMessage())
    }
